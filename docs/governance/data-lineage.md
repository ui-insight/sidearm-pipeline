...
| Achievement Suggestions | Final, non-exhibition Idaho player-game facts plus earlier eligible warehouse game facts | SQLAlchemy-authored aggregate and ranking queries detect career highs, season highs, career threshold crossings, and program top-N marks; score equals policy scope weight × metric importance weight | `achievement_suggestions` | later SID review, AI ranking, and phrasing workflows | Stores source-snapshot and Coverage Window context; no model generates or changes facts or numbers |
