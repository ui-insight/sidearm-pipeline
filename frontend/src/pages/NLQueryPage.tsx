  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-3xl mx-auto px-6 py-10">
        ...
        {error && (
          <div className="mb-6 text-sm text-red-700 bg-red-50 border border-red-200 rounded px-4 py-3">
            {error}
          </div>
        )}
          ...
          <div className="bg-white rounded-lg shadow-sm p-6 space-y-5">
            ...
            {result.sql && (
              <div>
                ...
                {sqlExpanded && (
                  <pre className="mt-2 text-xs font-mono bg-gray-50 border border-gray-200 rounded p-3 overflow-x-auto whitespace-pre-wrap">
                    {result.sql}
                  </pre>
                )}
              </div>
